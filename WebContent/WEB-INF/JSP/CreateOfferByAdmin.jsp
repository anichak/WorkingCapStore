...
$(document).ready(function(){
	  $("#cupon_type").change(function(){
	    ...
	    if (type == "buyandget") {
	    	...
	    	document.getElementById('product_id').options.length = 0;
	    	 $.ajax({  
	    	     ...
	    	     success : function(data) {
	    	    	 $('#product_id').append(
	                         $('<option></option>').html("please select a product Name")
	                     );
			...
			$('#cupon_name').attr('readonly', false);
			$("#cupon_name").val('');
...
$(document).ready(function(){
	  $("#submit").click(function(){
	    ...
	    if (type=="product") {
	    	 var pattern1 = new RegExp("^[A-Za-z]+[0-9]+$");
	    ...
	    if (des=="") {
	    	...
	    	return;
	    	 ...
	    	 $.ajax({  
	    	     type : "Post",   
	    	     url : "createOfferAdmin", 
	    	     dataType: 'json',
	    	     data: "name=" +  escape(name) + "&type=" + type + "&value="  
	    	       + value + "&des=" + escape(des),
	    	     success : function(data) {
	    	    	 alert(data);
...
<!--Search Bar Starts Here-->
	...
	<div class="middle-container">
		<div class="buttons">
			...
			<a href="createOfferAdmin" class="offer">Create Offer</a>
			<a href="removeOfferByAdmin"
