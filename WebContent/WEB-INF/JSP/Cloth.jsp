...
<script src="resources/Script/Cloth.js"></script>
...
<!--Search Bar Starts Here-->
	...
	<a class="logout" href="logout" id="logoutButton"><span>Logout</span><em></em></a>
			 </c:if></div>
		</c:otherwise>
	...
	<div id='cssmenu'>
		<ul>
			...
			<li class='active'><a href='Cloth' ><span>Clothing</span></a></li>
			...
			<div>
				...
				<div class="middle-container">
					...
					<div id="SearchedProduct" class="SearchedProduct">
						<legend>Available Computers & Accessories</legend>
					</div>
