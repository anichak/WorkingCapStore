...
<script src="resources/Script/Mobiles.js"></script>
...
<div id='cssmenu'>
		<ul>
			...
			<li><a href='Mobiles' class='active'><span>Mobiles @ Accessories</span></a></li>
			...
			<div>
				...
				<div class="middle-container">
					...
					<div id="SearchedProduct" class="SearchedProduct">
						<legend>Available Mobiles & Accessories</legend>
					</div>
