...
<title>Cap Store - Add Product Description</title>
...
<!--Search Bar Starts Here-->
	...
	<div class="middle-container">
		...
		<form action="fileinsertdescription" method="post"
			enctype="multipart/form-data">
			<p>
				Add product Property:<br />
			</p>
			<p>
				Specify your File:<br /> <input type="file" name="datasize"
					id="datasize"></input>
			</p>
			<div>
