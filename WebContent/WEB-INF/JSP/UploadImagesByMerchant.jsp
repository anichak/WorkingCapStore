...
<!--Search Bar Starts Here-->
	...
	<div class="middle-container"><form id="uploadImage" name="uploadImage" method="post" action="http://localhost:1729/CapStoreImageUpload/upload" enctype="multipart/form-data">
	<input type="file" name="album" id="album"/>
	<input type="submit" id="uploadmedia" value="Submit"/>
</form>
    </div>
