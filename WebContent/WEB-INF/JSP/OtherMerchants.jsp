	...
	<table border="1">
		...
		<c:forEach var="merchant" items="${list}">
			<tr>
				...
				<td><c:out value="${merchant.merchantAddeddate}"></c:out></td>
				<td><c:out value="${merchant.merchantRemoveddate}"></c:out></td>
				<td><a href="reapproveAMerchant?merchant_id=${merchant.merchantId}"><button>APPROVE</button></a></td>				
			</tr>
		</c:forEach>
	</table>
	</c:if>
