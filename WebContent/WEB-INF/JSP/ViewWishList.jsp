...
<!--Search Bar Starts Here-->
		...
		<form action="tsearch" method="get">
			...
			<input class="mainSubmit" value=" " id="searchbutton" type="button"
				style="position: relative; margin-left: -76px;">
		</form>
		<!--Search Bar Ends Here-->
	</div>
	<form name="wish" action="wishlist">
		<input type="button" class="headerbuttons" value="WishList"></input>
	</form>
	<!-- Login Starts Here -->
	...
	<div class="middle-container">
			...
			<table cellpadding="10" cellspacing="0" border="" class="display"
				...
				<thead>
					<tr style="background: #00BFFF; font-size: 14px">
						<th>Product Name</th>
						<th>Product Brand</th>
						<th>Image</th>
				</thead>
